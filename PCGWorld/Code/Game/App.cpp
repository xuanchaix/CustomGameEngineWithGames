...
void App::Startup() {
	...
	//io.DisplaySize = ImVec2( m_attractModeCamera->m_viewPort.m_maxs.x - m_attractModeCamera->m_viewPort.m_mins.x,
	//	m_attractModeCamera->m_viewPort.m_maxs.y - m_attractModeCamera->m_viewPort.m_mins.y );
	...
	g_theJobSystem->SetWorkerThreadType( 1, Loading_Job );
}
...
void App::Update() {
	...
	ImGui::NewFrame();
	ImGui::GetMainViewport()->Size = ImVec2( m_attractModeCamera->m_viewPort.m_maxs.x - m_attractModeCamera->m_viewPort.m_mins.x,
		m_attractModeCamera->m_viewPort.m_maxs.y - m_attractModeCamera->m_viewPort.m_mins.y );
	// 1398 730
	//1382 691
	g_theGame->Update();
...
{
// 	if (g_theGame->m_viewMode == MapViewMode::ViewModeSphere) {
// 		g_theRenderer->ClearScreen( Rgba8( 0, 0, 102 ), Rgba8::WHITE );
// 	}
// 	else {
		g_theRenderer->ClearScreen( Rgba8( 255, 255, 255, 255 ), Rgba8::WHITE );
/*	}*/

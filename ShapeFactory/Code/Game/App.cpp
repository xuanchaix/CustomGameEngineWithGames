...
void App::Startup() {
	...
	TileDefinition::SetUpDefinitions();
}
...
void App::SetUpTexture()
{
	...
	g_conveyorBeltSprite = new SpriteSheet( *(g_theRenderer->CreateOrGetTextureFromFile( "Data/Images/Buildings/conveyor-belt.png" )), IntVec2( 16, 20 ) );
}

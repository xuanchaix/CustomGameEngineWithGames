...
constexpr char const* APP_NAME = "Starship Ultimate";
...
extern SpriteSheet* g_pickupsSprites;
extern Texture* g_floorPortalTexture;
...
extern std::string g_starshipKeyStringMapping[256];